...
#
# grpc_generate_cpp (<SRCS> <HDRS> <CMAKE_CURRENT_BINARY_DIR> [<ARGN>...])
#
#  SRCS - variable to define with autogenerated source files
#  HDRS - variable to define with autogenerated header files
#  CMAKE_CURRENT_BINARY_DIR - directory where the source files will be created
#  ARGN - .proto files
#
function(GRPC_GENERATE_CPP SRCS HDRS)
  ...
  foreach(FIL ${ARGN})
    ...
    add_custom_command(
      ...
      ARGS --grpc_out ${CMAKE_CURRENT_BINARY_DIR} ${_protobuf_include_path} --plugin=protoc-gen-grpc=${GRPC_CPP_PLUGIN} ${ABS_FIL}
